...
#submit jobs to the cluster, creating a log in $logDir which includes reported errors:                	
	...
	qsub -N REMOVESC_$uniqueID -hold_jid STAR_$uniqueID -b y -wd $logDir -j y -R y -P GenomeInformatics -pe smp $numcores -V $remove_sc_line
