...
transcripts_ref_inPath="$resultsDir/4.star-cuffdiff_ercc_protocol/$samplename.$transcripts_ref_inType"
outDir="$resultsDir/5.star-cuffdiff_ercc_pairedinfo_protocol/$samplename.$outType"
...
cuffdiff_line="cuffdiff -o $outDir -labels control_proliferative,case_proliferative \
-num-threads $numcores -frag-bias-correct $genomeFile -multi-read-correct $transcripts_file \
${inFiles[0]},${inFiles[1]},${inFiles[2]} \
${inFiles[3]},${inFiles[4]},${inFiles[5]}"
